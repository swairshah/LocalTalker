...
final class Transcriber {
    ...
    static func findModelPath() -> String? {
        ...
        let commanderModels = Constants.modelsDir.appendingPathComponent("qwen-asr")
        if FileManager.default.fileExists(atPath: commanderModels.path) {
            return commanderModels.path
        }
